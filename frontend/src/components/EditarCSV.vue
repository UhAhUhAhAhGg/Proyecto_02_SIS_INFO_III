<template>
            ...
            <tbody>
              ...
              >
                <td v-for="(cell, colIndex) in row" :key="colIndex">
                  <input v-model="csvData[currentPage * rowsPerPage + rowIndex + 1][colIndex]" />
                </td>
              </tr>
            </tbody>
          </table>
    ...
    <div class="botones-weka">
      ...
      <button @click="enviarAWEKA('cluster')">Aplicar Clustering (K-Means)</button>
      <button @click="enviarAWEKA('perceptron')">Aplicar Perceptrón Multicapa</button>
    </div>
